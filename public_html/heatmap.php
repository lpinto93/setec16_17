...
<div id="hm-gen">
    <form action="heatmapgen.php" method="post">
        Starting date: <input type="datetime" name="start" value="2016-10-15T11:00:00Z"><br>

        Final date: <input type="datetime" name="finish" value="2016-10-15T13:00:00Z"><br>
